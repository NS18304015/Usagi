...
import database.KensakuoldQuery;
import java.util.List;


public class KensakuoldServlet extends HttpServlet{
	...
	throws IOException,ServletException{
		...
		req.setCharacterEncoding("SJIS");
			...
			List<UsagiProfile> plist=KensakuoldQuery.getQueryList(title);
			

			//HttpServletRequestの実装クラスのインスタンスに
			//nameという名前とpassという名前でデータを登録する
			req.setAttribute("users",plist);
			req.setAttribute("titleA",title);
