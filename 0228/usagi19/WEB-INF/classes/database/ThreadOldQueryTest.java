...
public class ThreadOldQueryTest{
	...
	public static List<UsagiProfile> getQueryList(String Tno){
		...
		try{
			...
			//select文
			String sql_1="select response_serialno,response_username,response_contents,response_rating,thread_name,thread_table.thread_no from response_table join thread_table on response_table.thread_no=thread_table.thread_no where thread_table.thread_no='"+Tno+"' order by response_serialno desc";
