...
public class IndexGoodQueryTest{
	...
	public static List<IndexProfile> getQueryList(){
		...
		try{
			...
			//select文
			String sql_1="select Thread_Name,Thread_Time,Response_Contents from THREAD_TABLE natural join RESPONSE_TABLE group by Thread_No order by sum(Response_Rating) asc";
