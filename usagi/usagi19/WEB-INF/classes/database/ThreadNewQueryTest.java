...
public class ThreadNewQueryTest{
	...
	public static void main(String[] args){
		...
		List<ThreadProfile> al = getThreadNewQueryList();
	...
	public static List<ThreadProfile> getThreadNewQueryList(){
		...
		try{
			...
			//select文
			String sql_1="select Response_SerialNo,Response_UserName,Response_Time,Response_Contents,Response_Rating from RESPONSE_TABLE order by Thread_Time desc";
