...
public class ThreadGoodQueryTest{
	...
	public static void main(String[] args){
		...
		List<ThreadProfile> al = getThreadGoodQueryList();
	...
	public static List<ThreadProfile> getThreadGoodQueryList(){
		...
		try{
			...
			//select文
			String sql_1="select Response_SerialNo,Response_UserName,Response_Time,Response_Contents,Response_Rating from RESPONSE_TABLE order by Response_Raring desc";
