...
public class KensakuoldQuery{
	
	public static void main(String[] args){
		
		List<UsagiProfile> al = getQueryList("kamiい");
	...
	public static List<UsagiProfile> getQueryList(String stitle){
		...
		try{
			...
			//select文
			String sql_1="select thread_table.Thread_no,thread_table.Thread_name from Thread_table where thread_name like '%" + stitle + "%' order by thread_no desc";
			...
			//if(count==0){
			//	throw new ServletException("検索結果が0件",null);
			//}
