...
public class IndexGoodQueryTest{
	...
	public static List<UsagiProfile> getQueryList(){
		...
		try{
			...
			//select文
			String sql_1="select t.thread_no,thread_name,response_username,response_contents,response_time from thread_table t join response_table r on t.thread_no=r.thread_no where r.response_serialno=1 group by t.thread_no,thread_name,response_username,response_contents,response_time order by sum(response_rating) desc";
