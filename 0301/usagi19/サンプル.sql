...
create user usagi identified by pass account unlock;
grant dba to usagi;
...
create table RESPONSE_TABLE(
	...
	Response_UserName VARCHAR2(100) NOT NULL,
	Response_Contents VARCHAR2(600) NOT NULL,
