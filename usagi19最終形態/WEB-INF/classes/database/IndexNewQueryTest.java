...
public class IndexNewQueryTest{
	...
	public static List<UsagiProfile> getQueryList(){
		...
		try{
			...
			//select文
			String sql_1="select thread_table.thread_no,thread_name,response_username,response_contents from thread_table join response_table on thread_table.thread_no=response_table.thread_no order by thread_table.thread_no desc";
